...
function (_AnyModel) {
  ...
  _createClass(NumberModel, [{
    ...
    value: function integer() {
      var check = new _Check.default('integer', function (value) {
    ...
    value: function decimal() {
      var check = new _Check.default('decimal', function (value) {
    ...
    value: function positive() {
      var check = new _Check.default('positive', function (value) {
    ...
    value: function negative() {
      var check = new _Check.default('negative', function (value) {
        return Math.sign(value) === -1;
      });
      this.checksManager.check(check);
      return this;
